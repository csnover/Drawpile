...
SETTING(contentFilterLevel        , ContentFilterLevel        , "pc/level"                              , parentalcontrols::Level::Unrestricted)
SETTING(contentFilterLocked       , ContentFilterLocked       , "pc/locked"                             , QByteArray())
SETTING(contentFilterTags         , ContentFilterTags         , "pc/tagwords"                           , parentalcontrols::defaultWordList())
