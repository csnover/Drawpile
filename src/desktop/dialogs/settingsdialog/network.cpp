	...
	: QWidget(parent)
{
	...
	auto *autoResetNoteLayout = utils::note(tr("If all operators in a session set connection quality to Poor, auto-reset will not work and the server may run out of memory."), QSizePolicy::Label);
