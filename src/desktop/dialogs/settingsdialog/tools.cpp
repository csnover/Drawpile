...
void Tools::initGeneralTools(desktop::settings::Settings &settings, utils::SanerFormLayout *form)
{
	...
	using desktop::settings::BrushCursorEnum;
	for (const auto &[name, value] : {
		std::pair { tr("Dot"), BrushCursorEnum::Dot },
		std::pair { tr("Crosshair"), BrushCursorEnum::Cross },
		std::pair { tr("Arrow"), BrushCursorEnum::Arrow },
		std::pair { tr("Right-handed triangle"), BrushCursorEnum::TriangleRight },
		std::pair { tr("Left-handed triangle"), BrushCursorEnum::TriangleLeft }
	}) {
