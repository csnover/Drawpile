...
QString current()
{
	...
	case Mode::Uninitialized:
	case Mode::Qt5:
		return QCoreApplication::translate("TabletInput", "Qt tablet input");
	case Mode::KisTabletWinink:
		return QCoreApplication::translate("TabletInput", "KisTablet Windows Ink input");
	case Mode::KisTabletWintab:
		return QCoreApplication::translate("TabletInput", "KisTablet Wintab input");
	case Mode::KisTabletWintabRelativePenHack:
		return QCoreApplication::translate("TabletInput", "KisTablet Wintab input with relative pen mode");
	case Mode::Qt6Winink:
		return QCoreApplication::translate("TabletInput", "Qt6 Windows Ink input");
	case Mode::Qt6Wintab:
		return QCoreApplication::translate("TabletInput", "Qt6 Wintab input");
	}
	Q_UNREACHABLE();
}
